                  ...
                  <Panel header={title}>
                      <form onSubmit={(event)=> this.handleForm(event)}>
                          <FormGroup>
                              ...
                              <FormControl onChange={(event)=> this.updateLoginForm(event, 'username')} value={this.props.username} type="text" />
                                  <br/>
                                  <ControlLabel>Password</ControlLabel>
                                  <FormControl onChange={(event)=> this.updateLoginForm(event, 'password')} value={this.props.password} type="password" />
                          </FormGroup>
                          <Button bsStyle="primary" type="submit" onClick={(event)=> this.handleForm(event)} >Submit
                          </Button>
                      </form>
                  </Panel>
              </Col>
